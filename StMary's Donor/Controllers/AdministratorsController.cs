...
namespace St.Marys_Donor.Controllers
{
    ...
    public class AdministratorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdentityUserId")] Administrator administrator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdentityUserId")] Administrator administrator)
        {
